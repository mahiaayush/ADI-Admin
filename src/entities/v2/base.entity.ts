...
declare type models =
  ...
  | 'UserFeedback'
  | 'CounselorScreen'
  | 'MasterScreeningStatus'
  | 'Language'
  | 'CounselorStatusMapper'
  | 'Interviewer'
  | 'CounselorInterviewFeedback'
  ...
  | 'UniversalOverride'
  | 'CounselorMasterAgreement'
  | 'CounselorAgreement'
  | 'TrainingMasterTopic'
  | 'UniversalWorkingHours'
  | 'SessionDescription'
  | 'CourseMasterDetails'
  | 'UserPackageShipping'
  | 'GlobalMasterRole'
  ...
  | 'CsmpCsp'
  | 'UserCheckoutCourses'
  | 'UserUsrAssociatecourse'
  | 'PublisherMasterDetails'
  | 'CsMemberShip'
  | 'cgMastercg'
  | 'cgMasterMeta'
  ...
  | 'GlobalMasterOffer'
  | 'GlobalMasterState'
  | 'GlobalRegionCouponMapper'
  | 'GlobalUserVpaMapper'
  | 'GlobalCardPtOfferingMapper'
  | 'GlobalCardSalesAllocation'
  | 'GlobalMasterTransaction'
  | 'GlobalPlatformOffering'
  | 'GlobalSalesDeposit'
  | 'GlobalSalesMetaData'
  | 'GlobalCouponPlatformOffering'
  | 'GlobalMasterBannerSection'
  | 'GlobalMasterTestimonial'
  | 'GlobalBlogsVideos'
  | 'GlobalMasterServices';

export { db_name, models };
