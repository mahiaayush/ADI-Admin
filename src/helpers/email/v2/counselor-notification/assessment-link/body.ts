        ...
        <tr>
            <td align="center" valign="top" width="100%" cellpadding="0" cellspacing="0">
                <table border="0" cellspacing="0" cellpadding="0" bgcolor="#f2e5fc" style=" font-weight: 700;"
                    ...
                    <tr>
                        <td width="100%" align="left" valign="top" style="font-weight: normal;  color:#302727; padding: 0 20px;">
                            <br><br>
                            Hi ${inputs.counselorName},
                            <br><br>
                            Take a quick test to expedite your candidature.
                            <br><br>
                            The test is already set up for you. 
                            All you have to do is click the assessment link at the end of the email, whenever you are ready.
                            <br><br>
                            Know more about <a href="https://help.imocha.io/how-to-take-a-test-on-the-imocha-platform" target = "_blank">how to take a test</a> on iMocha. For any queries, send an email to <a href = "mailto: counsellor.onboarding@launchmycareer.com">counsellor.onboarding@launchmycareer.com</a>
                            <br><br><br>        
                            ...
                            The LMC Team
                            <br><br>
                            <p><strong><u>Assessment Details:</u></strong><br>
                            <strong>Assessment Name:</strong> ICSC <br>
                            <strong>Duration:</strong> ${inputs.duration} min
                            <br><br>
                            <strong>Assessment Link:</strong> ${inputs.testUrl}
                            <br><br>
                            <strong>Assessment Validity:</strong> This assessment link is valid from <strong>${inputs.Test_start_time} (India Standard Time)</strong> to <strong>${inputs.Test_end_time} (India Standard Time).</strong>The assessment link will be active in mentioned time period only.
                            </p>
                            <br><br>
                    </tr>
