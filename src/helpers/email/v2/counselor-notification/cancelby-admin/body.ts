                    ...
                    <tr>
                        <td width="100%" align="left" valign="top" style="font-weight: normal; color:#302727; padding: 0 20px;">
                            ...
                            Hi ${
                              inputs?.userName
                                ? inputs.userName
                                : inputs.counselorFirstName
                            },
                            <br><br>
                            Sorry! Your Session has been cancelled, scheduled for ${
                              inputs.date
                            } at  ${inputs.time} (IST).
                            <br>
                            ${
                              inputs?.userName
                                ? 'We look forward to seeing you for the future session.'
                                : 'We will let you know if and when they reschedule.'
                            }  
                            <br>
                            <br><br>
                            Thanks,<br>
