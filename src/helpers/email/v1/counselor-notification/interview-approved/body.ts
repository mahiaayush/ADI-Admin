                ...
                <table border="0" cellspacing="0" cellpadding="0" bgcolor="#f2e5fc" style=" font-weight: 700;"
                    ...
                    <tr>
                        <td width="100%" align="left" valign="top" style="font-weight: normal; color:#302727; padding: 0 20px;">
                            ...
                            Hi ${inputs.firstName},
                            <br><br>                           
                            Great news! ${inputs.counselorName} passed the interview stage and can now move on to the next stage of offering one-to-one counselling sessions. 

                            <br><br>
                            To get started, we’ll need the following documents from them: 
                            <br> <br>
                            [Documents required to accept the offer] 
                            <br> <br>
